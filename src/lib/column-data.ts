...
export const articlesMap: Record<string, ArticleData> = {
  "pbr-explained": {
    ...
    body: `「PBR1倍割れだから割安！」と思って買ったのに、その後ずっと上がらなかった。投資を始めたばかりの頃、こんな経験をした人は多いはずだ。
...
PBRについてさらに詳しく知りたい方は、[株レンズの用語集・PBRページ](https://kabulens.jp/glossary/pbr)も合わせて読んでほしい。

## 動画で見る

この記事の内容を動画でも解説しています。

https://www.youtube.com/embed/gMTkuiYHdRM
...
https://www.youtube.com/embed/G-_eEWAca8o
